...
/**
 * Official Google Maps (2020) Icon SVG
 * Based on Wikimedia Commons source: File:Google_Maps_icon_(2020).svg
 */
export default function MapsLogo({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg 
      className={className} 
